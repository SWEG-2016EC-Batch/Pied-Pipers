...
int main() {
    ...
    cout << "Enter the capacity of an automobile fuel tank (gallons) : ";  
    ...
    cout << "The automobile can be driven " << miles_to_be_driven << " miles without refuelling" << endl;  // print the output
}
    return 0;
}
